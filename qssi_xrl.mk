...
# after qssi_xrl has been merged with the SoC build.
...
VENDOR_QTI_PLATFORM := qssi_xrl
VENDOR_QTI_DEVICE := qssi_xrl
...
$(call inherit-product, device/qcom/qssi_xrl/common64.mk)
...
TARGET_SYSTEM_PROP += device/qcom/qssi_xrl/system.prop
...
DEVICE_FRAMEWORK_MANIFEST_FILE := device/qcom/qssi_xrl/framework_manifest.xml
...
PRODUCT_COPY_FILES += \
    device/qcom/qssi_xrl/init.qcom.testscripts.sh:$(TARGET_COPY_OUT_PRODUCT)/etc/init.qcom.testscripts.sh
endif

PRODUCT_COPY_FILES += \
    device/qcom/qssi_xrl/public.libraries.product-qti.txt:$(TARGET_COPY_OUT_PRODUCT)/etc/public.libraries-qti.txt

# copy system_ext specific whitelisted libraries to system_ext/etc
PRODUCT_COPY_FILES += \
    device/qcom/qssi_xrl/public.libraries.system_ext-qti.txt:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/public.libraries-qti.txt
...
DEVICE_PACKAGE_OVERLAYS += device/qcom/qssi_xrl/overlay
endif
...
ifeq (true,$(call math_gt_or_eq,$(SHIPPING_API_LEVEL),29))
  $(call inherit-product, device/qcom/qssi_xrl/qssi_xrl_whitelist.mk)
